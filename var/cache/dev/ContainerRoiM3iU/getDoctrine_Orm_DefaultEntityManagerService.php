...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AnimalRepository' => function () {
    return ($this->privates['App\Repository\AnimalRepository'] ?? $this->load('getAnimalRepositoryService.php'));
}))));
