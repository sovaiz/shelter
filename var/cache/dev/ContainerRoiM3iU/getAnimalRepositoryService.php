...
// Returns the private 'App\Repository\AnimalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AnimalRepository.php';

return $this->privates['App\Repository\AnimalRepository'] = new \App\Repository\AnimalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
